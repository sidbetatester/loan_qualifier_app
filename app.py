...
def save_qualifying_loans(qualifying_loans):
    ...
    # if qualifying loans exist, then 
    ...
    # The tool should prompt the user to save the results as a CSV file, if user opts to save, then prompt them to provide path and filename for the new CSV.
        ...
        if Save_the_Data:
            ...
            print("You have opted not to save the loan data, thank you for using the App")

    # if there are no qualifying loans, the program should end without promting to save data
    else:
        print("You have no qualifying loans, thank you for using the App")
